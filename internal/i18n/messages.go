...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.oidc_auth_disabled":                       "通用 OIDC 登录未启用",
		"error.oidc_auth_config_invalid":                 "通用 OIDC 登录配置不合法",
		"error.oidc_state_invalid":                       "OIDC 登录会话已失效，请重试",
		"error.oidc_token_exchange_failed":               "OIDC 授权码换取令牌失败，请重试",
		"error.oidc_id_token_invalid":                    "OIDC 身份令牌校验失败",
		"error.oidc_payload_invalid":                     "OIDC 登录参数不合法",
		"error.oidc_bind_conflict":                       "该 OIDC 账号已绑定其他用户",
		"error.oidc_already_bound":                       "当前账号已绑定其他 OIDC 账号",
		"error.oidc_email_auto_link_forbidden":           "请先使用原账号登录，再绑定此 OIDC 账号",
	...
	LocaleTW: {
		...
		"error.oidc_auth_disabled":                       "通用 OIDC 登入未啟用",
		"error.oidc_auth_config_invalid":                 "通用 OIDC 登入配置不合法",
		"error.oidc_state_invalid":                       "OIDC 登入工作階段已失效，請重試",
		"error.oidc_token_exchange_failed":               "OIDC 授權碼換取權杖失敗，請重試",
		"error.oidc_id_token_invalid":                    "OIDC 身分權杖驗證失敗",
		"error.oidc_payload_invalid":                     "OIDC 登入參數不合法",
		"error.oidc_bind_conflict":                       "該 OIDC 帳號已綁定其他用戶",
		"error.oidc_already_bound":                       "目前帳號已綁定其他 OIDC 帳號",
		"error.oidc_email_auto_link_forbidden":           "請先使用原帳號登入，再綁定此 OIDC 帳號",
	...
	LocaleEN: {
		...
		"error.oidc_auth_disabled":                       "Generic OIDC login is disabled",
		"error.oidc_auth_config_invalid":                 "Generic OIDC login configuration is invalid",
		"error.oidc_state_invalid":                       "The OIDC login session expired, please try again",
		"error.oidc_token_exchange_failed":               "Failed to exchange the OIDC authorization code",
		"error.oidc_id_token_invalid":                    "OIDC ID token verification failed",
		"error.oidc_payload_invalid":                     "OIDC login payload is invalid",
		"error.oidc_bind_conflict":                       "This OIDC account is already bound to another user",
		"error.oidc_already_bound":                       "The current account is already bound to another OIDC account",
		"error.oidc_email_auto_link_forbidden":           "Sign in to the existing account first, then bind this OIDC account",
